...
def socks4_connect_request(offset, secret, address_type, address, port):

    # create illiad header
    request = illiad_header(offset, secret)

    # SOCKS4 version and CONNECT command
    request.extend(bytearray([0x04, 0x01, 0x00]))
...
# Example usage
socks_request = socks4_connect_request(offset1, secret1, "Domain", "example.com", 80)
print("example SOCKS4 CONNECT request:")
print(socks_request)
        ...
        # Create an SSL context
                ...
                with socket.create_connection((host, port)) as sock:
                    with context.wrap_socket(sock, server_hostname=host) as ssock:
                        ...
                        req = socks4_connect_request(offset, secret, "Domain", "sina.com.cn", 80)
