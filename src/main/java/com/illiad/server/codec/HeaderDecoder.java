...
public class HeaderDecoder extends ByteToMessageDecoder {
    ...
    public HeaderDecoder(HandlerNamer namer, Secret secret, Utils utils, V4ServerEncoder v4ServerEncoder, V5ServerEncoder v5ServerEncoder, V4CommandHandler v4CommandHandler, V5AddressDecoder v5AddressDecoder) {
        this.namer = namer;
        this.secret = secret;
        this.utils = utils;
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf byteBuf, List<Object> list) {
        ...
        ctx.pipeline().addLast(namer.generateName(), new VersionHandler(namer, utils, v4ServerEncoder, v4CommandHandler, v5ServerEncoder, v5AddressDecoder));
        // skip the header
